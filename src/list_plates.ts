...
/*export let polvitoUruguayo = new Plate("Polvito Uruguayo", new Map<Food, number>([[]]) , "Postre");
export let principeAlberto = new Plate("Principe Alberto", new Map<Food, number>([[]]) , "Postre");
*/